...
if entrada_aluno:
    ...
    prompt_sistema = (
        ...
        "4. "12. CONCEITOS VIA DESCOBERTA: Se o aluno solicitar definições (ex: o que é triângulo, equação, sucessão ou limite), a IA está proibida de entregar o texto ou a resposta pronta. "
